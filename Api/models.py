...
class User(UserMixin, db.Model):
    ...
    def set_password(self, password):
        """Establecer contraseña hasheada usando scrypt"""
        if not password:
        ...
        # Usar scrypt que es más seguro que pbkdf2
        self.password_hash = generate_password_hash(
            password, 
            method='scrypt:32768:8:1'  # Misma configuración que se ve en los datos existentes
        )
    ...
    def check_password(self, password):
        ...
        try:
            ...
            print(f"Error verificando contraseña para usuario {self.username}: {e}")
            return False
...
class Account(db.Model):
    ...
    def authenticate(username, password):
        ...
        try:
            ...
            print(f"Autenticando usuario: {username} {password}")
